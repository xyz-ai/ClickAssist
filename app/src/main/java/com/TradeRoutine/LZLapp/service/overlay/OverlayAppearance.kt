    ...
    companion object {
        fun fromSettings(
            ...
            val isDark = when (settings.themeMode) {
                com.TradeRoutine.LZLapp.ui.theme.AppThemeMode.FOLLOW_SYSTEM -> {
                    val uiMode = context.resources.configuration.uiMode and Configuration.UI_MODE_NIGHT_MASK
                    uiMode == Configuration.UI_MODE_NIGHT_YES
                }
                com.TradeRoutine.LZLapp.ui.theme.AppThemeMode.DARK -> true
                com.TradeRoutine.LZLapp.ui.theme.AppThemeMode.LIGHT -> false
            }
