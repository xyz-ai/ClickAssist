...
object RunnerErrorMessageMapper {
    ...
    fun map(error: RunnerError?): Int? {
        return when (error) {
            ...
            RunnerError.LongPressPointNotSet -> R.string.error_long_press_point_not_set
            RunnerError.SwipePointNotSet -> R.string.error_swipe_point_not_set
            is RunnerError.TapPointOutOfBounds -> R.string.error_tap_point_out_of_bounds
            is RunnerError.SwipePointOutOfBounds -> R.string.error_swipe_point_out_of_bounds
            ...
            is RunnerError.InvalidDurationMs -> R.string.error_invalid_duration_ms
